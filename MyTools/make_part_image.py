# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 12:08:06 2024

@author: ab19109
make_part_image.pyの改良版
リストのインデックスではなく辞書を作成して部位の名前でアクセスできるようにする+切り取り位置改良
"""
import numpy as np
import cv2
...
def crop_by_part(image, keys):
    # =============================================================================
    # image (str / ndarray): 処理を行う画像・画像のパス
    # keys (list[ndarray]): OpenPoseで検出したキーポイントの座標が入ったリスト    
    # =============================================================================
    ...
    #部位ごとに切り取る座標を決める
    coordinates = decide_coordinates(keys[0], w, h)
